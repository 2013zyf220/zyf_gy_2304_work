...
shp_1 <- shapefile('ppa_2301_k2/shp/2/2301_cq_water_b12_buf1000_a01.shp')
...
bh_1 <- list()
bh_1[[1]] <- raster(paste0('building_height_k2/CNBH10m_X107Y29_rep.tif')); #to_be_set
bh_1[[2]] <- raster(paste0('chongqing_bh/cq_bh4.tif')); #to_be_set
bh_1[[3]] <- raster(paste0('ppa_2301_k2/raster/bh_sum_3.tif')); #to_be_set
bh_1[[4]] <- raster(paste0('ppa_2301_k2/raster/bh_sum_2.tif')); #to_be_set
bh_set <- 1 #to_be_set_key
bh_2 <- bh_1[[bh_set]]
