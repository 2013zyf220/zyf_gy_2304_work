...
rayman_f1 <- function(f_para_tr, f_time){
  ...
  write.csv(f_rayman_1_df, paste0('RAYMAN/rayman_1_time', ii, '_', f_para_tr, '_', para_ws, '.csv'), row.names = FALSE)
  write.table(f_rayman_1_df, file = paste0('RAYMAN/rayman_1_time', ii, '_', f_para_tr, '_', para_ws, '.txt'), sep = ' ', row.names = FALSE, col.names = TRUE, quote = FALSE)
}
