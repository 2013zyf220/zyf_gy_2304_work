...
prov_1 <- c('chongqing','sichuang','hubei','zhejiang','jiangsu') #to_be_set(province)
shp_data_1 <- c('chongqing_1','chengdu_1','wuhan_1','hangzhou_1','nanjing_1') #to_be_set(shp data)
